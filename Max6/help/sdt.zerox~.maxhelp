...
,
					"patching_rect" : [ 392.0, 21.0, 216.0, 116.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 64.0, 307.0, 64.0, 27.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 64.0, 271.0, 72.0, 23.0 ],
					"style" : "",
					"text" : "sdt.zerox~"
				}
