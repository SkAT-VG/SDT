...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.0, 324.5, 445.0, 349.0 ],
									"style" : "",
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 561.524536, 503.5, 224.729004, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 368.5, 77.0, 29.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.5, 219.5, 81.0, 28.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 81.0, 158.5, 69.0, 28.0 ],
					"style" : "",
					"text" : "impact \nvelocity (m/s)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.0, 252.5, 27.0, 110.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 189.0, 27.0, 110.0 ],
					"setminmax" : [ 0.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.0, 405.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 88.0, 305.5, 50.0, 19.0 ],
					"style" : "",
					"text" : "6.050909"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 592.0, 601.0, 46.5, 19.0 ],
					"style" : "",
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 338.0, 514.0, 292.0, 42.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.5, 273.0, 62.0, 28.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 145.5625, 263.75, 62.0, 28.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 243.0, 320.0, 35.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.5625, 295.0, 40.0, 40.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 243.0, 427.5, 35.0, 19.0 ],
					"style" : "",
					"text" : "sel 97"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 243.0, 399.0, 59.5, 19.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 243.0, 449.0, 36.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.5625, 220.0, 40.0, 40.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.0, 497.0, 62.0, 39.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 140.25, 189.0, 78.375, 28.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 592.0, 565.0, 32.5, 19.0 ],
					"style" : "",
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 556.0, 99.0, 19.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.5, 368.5, 86.5, 19.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.200012, 743.0, 588.0, 42.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 432.680542, 358.5, 349.0, 59.0 ],
					"style" : "",
					"text" : "sdt.modal objectcr 3 2 @freqs 500. 1000. 1500 @decays 0.06 0.03 0.01 @weights 50. 50. 50. @pickup0 1. 1. 1. @pickup1 1. 1. 1. @activeModes 3"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 203.5, 419.5, 155.0, 22.0 ],
					"style" : "",
					"text_width" : 110.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 368.5, 86.5, 19.0 ],
					"style" : "",
					"text" : "scale 0. 100. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 943.5, 71.0, 29.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.5625, 1176.0, 117.0, 17.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 386.0, 1176.0, 171.0, 17.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 267.0, 1117.5, 297.0, 59.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 34.0, 661.5, 349.0, 59.0 ],
					"style" : "",
					"text" : "sdt.impact~ hammercr objectcr 3 @stiffness 10000000 @shape 1.5 @dissipation 0.01 @contact0 0 @contact1 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 442.680542, 587.5, 50.0, 19.0 ],
					"style" : "",
					"text" : "8909"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 454.680542, 503.5, 26.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 436.680542, 473.5, 62.0, 17.0 ],
					"style" : "",
					"text" : "extra gain"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 221.0, 473.5, 84.444458, 28.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 646.389038, 290.5, 48.0, 17.0 ],
					"style" : "",
					"text" : "weight_3"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 574.951538, 290.5, 48.0, 17.0 ],
					"style" : "",
					"text" : "weight_2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 508.514038, 290.5, 48.0, 17.0 ],
					"style" : "",
					"text" : "weight_1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.5, 711.5, 52.0, 19.0 ],
					"style" : "",
					"text" : "strike 0 $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 658.555542, 642.0, 72.0, 72.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 488.458313, 638.5, 20.0, 79.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 448.902771, 638.5, 37.555542, 79.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 52.5, 619.5, 72.0, 19.0 ],
					"style" : "",
					"text" : "170371840."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 424.680542, 122.0, 375.0625, 324.5 ],
					"proportion" : 0.39,
					"rounded" : 6,
					"style" : "",
					"varname" : "String[4]"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 424.680542, 448.5, 375.0625, 301.0 ],
					"proportion" : 0.39,
					"rounded" : 6,
					"style" : "",
					"varname" : "String[2]"
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 347.5, 645.0, 687.700012, 645.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 347.5, 645.0, 48.25, 645.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 601.5, 672.0, 198.0, 672.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 187.5, 534.75, 629.0, 534.75 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 554.5, 1248.25, 435.0, 1248.25 ],
					"source" : [ "obj-63", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 198.0, 738.25, 48.25, 738.25 ],
					"source" : [ "obj-77", 0 ]
				}
