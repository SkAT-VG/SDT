...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 188.0, 301.5, 132.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 188.0, 284.5, 65.0, 17.0 ],
					"text" : "snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 228.5, 121.0, 18.0 ],
					"text" : "pitch clarity [0.0 ~ 1.0]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 86.5, 310.0, 20.0 ],
					"text" : " NSDF based pitch detector"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 188.0, 255.5, 78.0, 24.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 37.0, 199.5, 170.0, 23.0 ],
					"text" : "sdt.pitch~ 4096"
				}
