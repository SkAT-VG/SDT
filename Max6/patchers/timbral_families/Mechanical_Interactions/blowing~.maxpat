...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 351.0, 341.5, 146.0, 45.0 ],
...
,
					"patching_rect" : [ 168.25, 234.5, 39.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 168.25, 341.5, 171.5, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 614.0, 506.0, 70.0, 18.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 665.0, 372.5, 46.0, 18.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 678.5, 418.0, 69.0, 18.0 ],
					"text" : "pack 0. 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 400.0, 69.0, 18.0 ],
					"text" : "pack 1.5 700"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 665.0, 444.75, 46.0, 18.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.75, 115.0, 62.0, 18.0 ],
					"text" : "loadmess 1"
				}
...
,
					"patching_rect" : [ 244.75, 234.5, 39.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 9.0,
...
,
					"patching_rect" : [ 30.0, 234.5, 39.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-26", "flonum", "float", 0.262, 5, "obj-5", "flonum", "float", 0.336533, 5, "obj-8", "flonum", "float", 0.353, 5, "obj-10", "flonum", "float", 0.203, 5, "obj-38", "toggle", "int", 1, 5, "obj-43", "toggle", "int", 1, 5, "obj-59", "toggle", "int", 1, 6, "obj-84", "gain~", "list", 94, 10.0, 6, "obj-52", "gain~", "list", 140, 10.0, 6, "obj-91", "gain~", "list", 127, 10.0 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 351.0, 270.5, 70.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 168.25, 270.5, 70.0, 30.0 ],
					"textcolor" : [ 0.0, 0.8, 1.0, 1.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 270.5, 70.0, 30.0 ],
					"textcolor" : [ 0.0, 0.8, 1.0, 1.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.75, 270.5, 70.0, 30.0 ],
					"textcolor" : [ 0.0, 0.8, 1.0, 1.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.75, 307.5, 68.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 351.0, 307.5, 42.0, 18.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 307.5, 42.0, 18.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 168.25, 307.5, 42.0, 18.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 341.5, 120.0, 26.0 ],
					"text" : "sdt.windflow~"
				}
