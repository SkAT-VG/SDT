...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1015.0, 26.0, 120.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 316.0, 406.0, 124.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 570.0, 452.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.0, 468.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 403.0, 366.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 483.0, 468.0, 86.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 316.0, 368.0, 86.0, 13.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 72.0, 62.0, 50.0, 20.0 ]
								}
...
,
					"patching_rect" : [ 101.0, 591.0, 86.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "break_interactivecontrols.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "hit" ],
					"patching_rect" : [ 672.0, 98.0, 377.0, 191.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 428.0, 379.0, 185.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 535.0, 108.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 198.0, 83.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 215.0, 146.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 359.0, 161.0, 146.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 175.0, 142.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 359.0, 121.0, 142.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 159.0, 78.0, 17.0 ],
					"text" : "r #1thispbreak"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 65.0, 100.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 123.0, 86.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 49.0, 199.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 179.0, 79.0, 17.0 ],
					"text" : "r #1closebreak"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.5, 254.0, 73.0, 15.0 ],
					"text" : "dispose, clean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.0, 617.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 12,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 531.0, 40.0, 148.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 168.0, 98.0, 468.0, 408.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 2.0, 468.0, 408.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 669.5, 75.0, 626.5, 75.0 ],
					"source" : [ "obj-15", 11 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 657.772705, 75.0, 585.681824, 75.0 ],
					"source" : [ "obj-15", 10 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 646.045471, 75.0, 544.863647, 75.0 ],
					"source" : [ "obj-15", 9 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 634.318176, 75.0, 504.045441, 75.0 ],
					"source" : [ "obj-15", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 622.590881, 75.0, 463.227264, 75.0 ],
					"source" : [ "obj-15", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 610.863647, 75.0, 422.409088, 75.0 ],
					"source" : [ "obj-15", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 599.136353, 75.0, 381.590912, 75.0 ],
					"source" : [ "obj-15", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 587.409119, 75.0, 340.772736, 75.0 ],
					"source" : [ "obj-15", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 575.681824, 75.0, 299.954559, 75.0 ],
					"source" : [ "obj-15", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 563.954529, 75.0, 259.136353, 75.0 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 552.227295, 75.0, 218.318176, 75.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 540.5, 75.0, 177.5, 75.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1024.5, 66.0, 983.0, 66.0, 983.0, 89.0, 681.5, 89.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 681.5, 287.0, 660.0, 287.0, 660.0, 88.0, 626.5, 88.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 579.0, 562.0, 177.5, 562.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 14.5, 235.0, 58.5, 235.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "breaking_control_data.maxpat",
				"bootpath" : "/Users/sdm/Documents/LAVORI/RICERCA/SObs/SoundDesignTools/branches/SObWay/SDT_Max6/SDT_patches/SDT_contents/Library/Breaking",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
