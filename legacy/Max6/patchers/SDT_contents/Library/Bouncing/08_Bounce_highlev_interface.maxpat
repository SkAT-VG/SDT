...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 640.0, 428.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 640.0, 444.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 408.0, 368.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 444.0, 86.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 321.0, 368.0, 86.0, 13.0 ],
...
,
					"patching_rect" : [ 151.0, 509.0, 86.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1101.0, 103.0, 120.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 329.0, 411.0, 120.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "bounce_interactivecontrols.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "hit" ],
					"patching_rect" : [ 788.0, 124.0, 306.0, 203.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 431.0, 382.0, 203.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 492.0, 113.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 247.0, 88.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 287.0, 146.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 374.0, 178.0, 146.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 247.0, 142.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 384.0, 121.0, 142.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 208.0, 83.0, 17.0 ],
					"text" : "r #1thispbounce"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 170.0, 187.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 210.0, 88.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 96.0, 248.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 228.0, 84.0, 17.0 ],
					"text" : "r #1closebounce"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 306.0, 73.0, 15.0 ],
					"text" : "dispose, clean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 96.0, 534.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 12,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 575.0, 49.0, 157.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 242.0, 81.0, 468.0, 400.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 3.0, 468.0, 400.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 722.5, 70.0, 700.5, 70.0 ],
					"source" : [ "obj-15", 11 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 709.954529, 70.0, 659.681824, 70.0 ],
					"source" : [ "obj-15", 10 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 697.409119, 70.0, 618.863647, 70.0 ],
					"source" : [ "obj-15", 9 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 684.863647, 70.0, 578.045471, 70.0 ],
					"source" : [ "obj-15", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 672.318176, 70.0, 537.227295, 70.0 ],
					"source" : [ "obj-15", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 659.772705, 70.0, 496.409088, 70.0 ],
					"source" : [ "obj-15", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 647.227295, 70.0, 455.590912, 70.0 ],
					"source" : [ "obj-15", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 634.681824, 70.0, 414.772736, 70.0 ],
					"source" : [ "obj-15", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 622.136353, 70.0, 373.954559, 70.0 ],
					"source" : [ "obj-15", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 609.590881, 70.0, 333.136353, 70.0 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 597.045471, 70.0, 292.318176, 70.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 584.5, 70.0, 251.5, 70.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1110.5, 201.0, 1044.0, 201.0, 1044.0, 114.0, 797.5, 114.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 797.5, 353.0, 743.0, 353.0, 743.0, 76.0, 700.5, 76.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 649.0, 480.0, 227.5, 480.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 61.5, 284.0, 105.5, 284.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "bounce_control_data.maxpat",
				"bootpath" : "/Users/sdm/Documents/LAVORI/RICERCA/SObs/SoundDesignTools/branches/SObWay/SDT_Max6/SDT_patches/SDT_contents/Library/Bouncing",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
