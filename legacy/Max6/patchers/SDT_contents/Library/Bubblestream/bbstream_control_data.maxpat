{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 70.0, 462.0, 459.0, 424.0 ],
		"bglocked" : 0,
		"defrect" : [ 70.0, 462.0, 459.0, 424.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_presetinterpolation",
					"outlettype" : [ "" ],
					"color" : [ 1.0, 0.360784, 0.682353, 1.0 ],
					"patching_rect" : [ 233.0, 227.0, 165.0, 17.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_bbradius",
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 69.0, 117.0, 17.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_frequency",
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 179.0, 124.0, 17.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_envelope",
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 156.0, 118.0, 17.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_slopevar",
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 134.0, 118.0, 17.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_blslope",
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 113.0, 110.0, 17.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbstream_radiusvar",
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 90.0, 123.0, 17.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
