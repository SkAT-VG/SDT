...
, 							{
								"box" : 								{
									...
									"text" : "sprintf %s/Presets/Impact/Rhythmic"
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-60",
					"items" : [ ".svn/entries", ",", ".svn/prop-base", ",", ".svn/props", ",", ".svn/text-base", ",", ".svn/tmp", ",", ".svn/tmp/prop-base", ",", ".svn/tmp/props", ",", ".svn/tmp/text-base", ",", "rhythm.maxpat", ",", "rhythm2.maxpat" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"prefix" : "Stef:/Users/sdm/Documents/LAVORI/RICERCA/SObs/SoundDesignTools/branches/SObWay/SDT_Max6/SDT_patches/SDT_contents/Presets/Impact/Rhythmic/",
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 176.0, 32.5, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 172.75, 46.0, 32.5, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 157.0, 30.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 133.0, 46.0, 30.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 344.0, 15.0, 15.0 ]
				}
