...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1079.0, 51.0, 120.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 391.0, 463.0, 120.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 752.0, 396.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 752.0, 412.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 494.0, 347.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 665.0, 412.0, 86.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 347.0, 86.0, 13.0 ],
...
,
					"patching_rect" : [ 196.0, 500.0, 86.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-13",
					"maxclass" : "bpatcher",
					"name" : "crump_interactivecontrols.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ -320.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 844.0, 107.0, 299.0, 185.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 393.0, 324.0, 185.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 466.0, 127.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 10,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 717.0, 33.0, 131.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 126.0, 86.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 166.0, 146.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 485.0, 136.0, 146.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 126.0, 142.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 485.0, 95.0, 142.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 87.0, 81.0, 17.0 ],
					"text" : "r #1thispcrump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 206.0, 51.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 89.0, 94.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 146.0, 127.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.0, 107.0, 82.0, 17.0 ],
					"text" : "r #1closecrump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.0, 185.0, 73.0, 15.0 ],
					"text" : "dispose, clean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 146.0, 530.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 264.0, 63.0, 555.0, 388.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 3.0, 555.0, 388.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 853.5, 300.0, 829.0, 300.0, 829.0, 15.0, 273.5, 15.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1088.5, 74.0, 825.0, 74.0, 825.0, 98.0, 853.5, 98.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 838.5, 55.0, 809.5, 55.0 ],
					"source" : [ "obj-2", 9 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 826.055542, 55.0, 749.944458, 55.0 ],
					"source" : [ "obj-2", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 813.611084, 55.0, 690.388916, 55.0 ],
					"source" : [ "obj-2", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 801.166687, 55.0, 630.833313, 55.0 ],
					"source" : [ "obj-2", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 788.722229, 55.0, 571.277771, 55.0 ],
					"source" : [ "obj-2", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 776.277771, 55.0, 511.722229, 55.0 ],
					"source" : [ "obj-2", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 763.833313, 55.0, 452.166656, 55.0 ],
					"source" : [ "obj-2", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 751.388916, 55.0, 392.611115, 55.0 ],
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 738.944458, 55.0, 333.055542, 55.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 726.5, 55.0, 273.5, 55.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 272.5, 519.0, 202.0, 526.0 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 205.5, 521.0, 155.5, 521.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 761.0, 481.0, 272.5, 481.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 111.5, 163.0, 155.5, 163.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"name" : "crump_control_data.maxpat",
				"bootpath" : "/Users/sdm/Documents/LAVORI/RICERCA/SObs/SoundDesignTools/branches/SObWay/SDT_Max6/SDT_patches/SDT_contents/Library/Crumpling",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
