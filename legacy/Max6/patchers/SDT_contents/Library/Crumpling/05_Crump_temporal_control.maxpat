...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 67.0, 205.0, 167.0, 17.0 ],
									"text" : "sprintf %s/Presets/Crumpling/Rhythmic"
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-60",
					"items" : [ ".svn/entries", ",", ".svn/prop-base", ",", ".svn/props", ",", ".svn/text-base", ",", ".svn/tmp", ",", ".svn/tmp/prop-base", ",", ".svn/tmp/props", ",", ".svn/tmp/text-base", ",", "patter" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"prefix" : "Stef:/Users/sdm/Documents/LAVORI/RICERCA/SObs/SoundDesignTools/branches/SObWay/SDT_Max6/SDT_patches/SDT_contents/Presets/Crumpling/Rhythmic/",
					"presentation" : 1,
