...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "Ccrumpling_allmaps.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 89.0, 299.0, 185.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 308.0, 0.0, 299.0, 284.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 270.0, 284.0 ],
					"varname" : "05_CCrump_highlev_tempcontr"
				}
...
, 			{
				...
				"patcherrelativepath" : "../Cont_crumpling/MIDI_OSC_contcrump",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
