...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1051.0, 140.0, 120.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 301.0, 489.0, 120.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 616.0, 413.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 616.0, 429.0, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 422.0, 359.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 529.0, 429.0, 86.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 336.0, 360.0, 86.0, 13.0 ],
...
,
					"patching_rect" : [ 94.0, 565.0, 86.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "Ccrump_interactivecontrols.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ -307.0, 0.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 726.0, 105.0, 299.0, 185.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 399.0, 290.0, 284.0 ],
					"varname" : "Ccrump_interactivecontrols"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 494.0, 117.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 184.0, 92.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 172.0, 224.0, 146.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 395.0, 128.0, 146.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 172.0, 184.0, 142.0, 25.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 395.0, 88.0, 142.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 145.0, 87.0, 17.0 ],
					"text" : "r #1thispCcrump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 113.0, 105.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 128.0, 157.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 51.0, 185.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 165.0, 88.0, 17.0 ],
					"text" : "r #1closeCcrump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 243.0, 73.0, 15.0 ],
					"text" : "dispose, clean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.0, 594.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 575.0, 36.0, 123.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 198.0, 70.0, 468.0, 398.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 2.0, 468.0, 398.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 688.5, 59.0, 656.5, 59.0 ],
					"source" : [ "obj-15", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 673.642883, 59.0, 592.357117, 59.0 ],
					"source" : [ "obj-15", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 658.785706, 59.0, 528.214294, 59.0 ],
					"source" : [ "obj-15", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 643.928589, 59.0, 464.071442, 59.0 ],
					"source" : [ "obj-15", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 629.071411, 59.0, 399.928558, 59.0 ],
					"source" : [ "obj-15", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 614.214294, 59.0, 335.785706, 59.0 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 599.357117, 59.0, 271.642853, 59.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 584.5, 59.0, 207.5, 59.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1060.5, 194.0, 1037.0, 194.0, 1037.0, 96.0, 735.5, 96.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 735.5, 295.0, 695.0, 295.0, 695.0, 17.0, 335.785706, 17.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 170.5, 590.0, 60.5, 590.0 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 103.5, 588.0, 60.5, 588.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 625.0, 465.0, 170.5, 465.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 16.5, 221.0, 60.5, 221.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"name" : "Ccrump_control_data.maxpat",
				"bootpath" : "/Users/sdm/Documents/LAVORI/RICERCA/SObs/SoundDesignTools/branches/SObWay/SDT_Max6/SDT_patches/SDT_contents/Library/Cont_crumpling",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
