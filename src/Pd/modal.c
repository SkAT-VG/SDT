...
void modal_setup(void) {
  ...
  class_addmethod(modal_class, (t_method)modal_freqs, gensym("freqs"), A_GIMME,
                  0);
  class_addmethod(modal_class, (t_method)modal_decays, gensym("decays"),
                  A_GIMME, 0);
  class_addmethod(modal_class, (t_method)modal_pickup, gensym("pickup"),
                  A_GIMME, 0);
  class_addmethod(modal_class, (t_method)modal_fragmentSize,
                  gensym("fragmentSize"), A_FLOAT, 0);
  class_addmethod(modal_class, (t_method)modal_activeModes,
