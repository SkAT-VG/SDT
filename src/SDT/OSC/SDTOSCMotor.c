...
_SDTOSC_LOAD_FUNCTION(Motor)
_SDTOSC_LOADS_FUNCTION(Motor)
...
_SDTOSC_FLOAT_SETTER_FUNCTION(Motor, compressionRatio, CompressionRatio, double)
...
_SDTOSC_FLOAT_SETTER_FUNCTION(Motor, damp, Damp, double)
_SDTOSC_FLOAT_SETTER_FUNCTION(Motor, dc, Dc, double)
