...
@return Return code */
// extern SDTOSCReturnCode SDTOSCProject(void (* log)(const char *, ...), const
// SDTOSCMessage* x);
...
@return Return code */
// extern SDTOSCReturnCode SDTOSCProject_log(void (* log)(const char *, ...),
...
FILE ID0 ID1 ...
@param [in] log Log function pointer
@param [in] args Additional OSC arguments: file path (string), object IDs
(strings)
@return Return code */
// extern SDTOSCReturnCode SDTOSCProject_save(void (* log)(const char *, ...),
// const SDTOSCArgumentList* args);
...
@return Return code */
// SDTOSCReturnCode SDTOSCProject_load(void (*log)(const char*, ...), const
...
@param[in] x OSC message
@return Return code */
// extern SDTOSCReturnCode SDTOSCProjectMetadata(void (* log)(const char *,
...
@param [in] args Additional OSC arguments: file path (string)
@return Return code */
// extern SDTOSCReturnCode SDTOSCProjectMetadata_save(void (* log)(const char *,
// ...), const SDTOSCArgumentList* args);
...
@param [in] args Additional OSC arguments: file path (string)
@return Return code */
// extern SDTOSCReturnCode SDTOSCProjectMetadata_load(void (* log)(const char *,
// ...), const SDTOSCArgumentList* args);
...
@return Return code */
// extern SDTOSCReturnCode SDTOSCProjectMetadata_set(void (* log)(const char *,
// ...), const SDTOSCArgumentList* args);
