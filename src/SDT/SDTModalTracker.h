...
extern SDTModalTracker *SDTModalTracker_new(unsigned int nModes, unsigned int bufferSize, unsigned int winSize);
...
extern int SDTModalTracker_readSamples(SDTModalTracker *x, double *in, unsigned int n);
...
extern int SDTModalTracker_clearSamples(SDTModalTracker *x, unsigned int n);
