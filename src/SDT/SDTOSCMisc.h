...
#define SDT_OSC_LOG_H(SDT_TYPE) extern SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), _log) (void (* log)(const char *, ...), const char *key, SDT_TYPE_FULL(SDT_TYPE) *x);

/** @brief Define the OSC logging method
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_LOG(SDT_TYPE) SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), _log) (void (* log)(const char *, ...), const char *key, SDT_TYPE_FULL(SDT_TYPE) *x) { \
...
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_SAVE_H(SDT_TYPE) extern SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), _save)(void (* log)(const char *, ...), const char *key, SDT_TYPE_FULL(SDT_TYPE) *x, const SDTOSCArgumentList *args);

/** @brief Define the OSC save method
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_SAVE(SDT_TYPE) SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), _save)(void (* log)(const char *, ...), const char *key, SDT_TYPE_FULL(SDT_TYPE) *x, const SDTOSCArgumentList *args) { \
...
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_LOAD_H(SDT_TYPE) extern SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), _load)(void (* log)(const char *, ...), const char *key, SDT_TYPE_FULL(SDT_TYPE) *x, const SDTOSCArgumentList *args);

/** @brief Define the OSC load method
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_LOAD(SDT_TYPE) SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), _load)(void (* log)(const char *, ...), const char *key, SDT_TYPE_FULL(SDT_TYPE) *x, const SDTOSCArgumentList *args) { \
  json_value *obj; \
  char *name = malloc(sizeof(char) * (strlen(key) + 8)); \
  sprintf(name, "'%s'", key); \
  ...
  if (return_code == SDT_OSC_RETURN_OK) { \
    SDT_TYPE_FULL(SDT_TYPE) *r = CONCAT(SDT_TYPE_FULL(SDT_TYPE), _fromJSON)(obj); \
...
#define SDT_OSC_TYPE_SETTER_H(SDT_TYPE, F, T, S, K, J, D) extern SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), CONCAT(_set, S))(SDT_TYPE_FULL(SDT_TYPE) *x, const SDTOSCArgumentList *args);

#define SDT_OSC_TYPE_SETTER(SDT_TYPE, F, T, S, K, J, D) SDTOSCReturnCode CONCAT(CONCAT(SDTOSC, SDT_TYPE), CONCAT(_set, S))(SDT_TYPE_FULL(SDT_TYPE) *x, const SDTOSCArgumentList *args) { \
...
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_TYPE_MAKE_SETTERS(SDT_TYPE) SDT_TYPE ## _ATTRIBUTES(SDT_TYPE, SDT_OSC_TYPE_SETTER)

/** @brief Define the OSC setter methods declarations
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_TYPE_MAKE_SETTERS_H(SDT_TYPE) SDT_TYPE ## _ATTRIBUTES(SDT_TYPE, SDT_OSC_TYPE_SETTER_H)

#define SDT_OSC_TYPE_SETTER_SWITCH(SDT_TYPE, F, T, S, K, J, D) else if (!strcmp( #K , method)) \
return_code = CONCAT(CONCAT(SDTOSC, SDT_TYPE), CONCAT(_set, S))(obj, sub_args);

/** @brief Define the OSC root method declaration for the class
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_ROOT_H(SDT_TYPE) extern SDTOSCReturnCode CONCAT(SDTOSC, SDT_TYPE)(void (* log)(const char *, ...), const SDTOSCMessage* x);

/** @brief Define the OSC root method for the class
@param[in] SDT_TYPE The SDT type macro */
#define SDT_OSC_ROOT(SDT_TYPE) SDTOSCReturnCode CONCAT(SDTOSC, SDT_TYPE)(void (* log)(const char *, ...), const SDTOSCMessage* x) { \
  ...
  if (obj) \
    if (SDTOSCMessage_hasContainer(x)) { \
      ...
      if (!strcmp("log", method)) \
        ...
        return_code = CONCAT(CONCAT(SDTOSC, SDT_TYPE), _save)(log, key, obj, sub_args); \
      else if (!strcmp("load", method)) \
        return_code = CONCAT(CONCAT(SDTOSC, SDT_TYPE), _load)(log, key, obj, sub_args); \
...
/** @brief Define the declarations for all the OSC methods of the class (log, save, load, setters and root)
...
/** @brief Define the all the OSC methods for the class (log, save, load, setters and root)
@param[in] TYPE The SDT type macro (without the leading "SDT_")
@param[in] NAME The name of the class (as will be called via OSC) */
