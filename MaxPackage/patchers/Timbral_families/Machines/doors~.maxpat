...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 144.5, 379.0, 100.0, 20.0 ],
					"style" : "",
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.5, 354.0, 100.0, 20.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 442.5, 273.0, 38.0, 20.0 ],
					"style" : "",
					"text" : "del 20"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 289.5, 186.0, 116.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 40.5, 656.0, 503.5, 46.0 ],
					"style" : "",
					"text" : "sdt.reverb~ @xSize 4 @ySize 1 @zSize 3 @time 0.2 @time1k 0.17 @randomness 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 634.75, 224.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 415.5, 164.5, 82.0, 17.0 ],
					"style" : "",
					"text" : "shut!"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 77.0, 161.0, 46.0, 22.0 ],
									"style" : "",
									"text" : "*~ 200"
								}
...
,
					"patching_rect" : [ 553.0, 669.0, 90.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 694.25, 538.5, 28.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 647.25, 538.5, 43.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 647.25, 423.0, 75.0, 75.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 634.75, 261.0, 87.5, 47.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 12, "obj-71", "multislider", "list", 735.294128, 720.588257, 713.235291, 750.0, 691.176453, 455.882355, 426.470581, 308.823517, 12, "obj-33", "multislider", "list", 0.003919, 0.00464, 0.001145, 0.000821, 0.000749, 0.000604, 0.000424, 0.000352, 12, "obj-40", "multislider", "list", 245.588242, 391.176483, 463.970581, 5777.941406, 7088.235352, 8980.882812, 9199.264648, 10000.0 ]
						}
, 						{
							"number" : 2,
							"data" : [ 12, "obj-71", "multislider", "list", 433.823517, 308.823517, 250.0, 205.882355, 176.470581, 147.058823, 125.0, 117.647057, 12, "obj-33", "multislider", "list", 0.000965, 0.001217, 0.001649, 0.001865, 0.002334, 0.003199, 0.004063, 0.00464, 12, "obj-40", "multislider", "list", 245.588242, 391.176483, 463.970581, 755.147034, 755.147034, 827.941162, 1191.911743, 1410.294067 ]
						}
, 						{
							"number" : 3,
							"data" : [ 12, "obj-71", "multislider", "list", 838.235291, 875.0, 742.647034, 742.647034, 544.117676, 367.647064, 301.470581, 257.352936, 12, "obj-33", "multislider", "list", 0.003919, 0.00464, 0.003991, 0.001361, 0.001073, 0.001001, 0.000676, 0.000496, 12, "obj-40", "multislider", "list", 245.588242, 391.176483, 2138.235352, 5777.941406, 7088.235352, 8980.882812, 9199.264648, 10000.0 ]
						}
 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 414.5, 337.0, 66.5, 19.0 ],
					"style" : "",
					"text" : "line 0. 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.5, 303.0, 49.0, 19.0 ],
					"style" : "",
					"text" : "3., 0. 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.5, 327.0, 91.0, 20.0 ],
					"style" : "",
					"text" : "prepend decays"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.5, 327.0, 85.5, 20.0 ],
					"style" : "",
					"text" : "prepend freqs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.5, 164.5, 82.0, 17.0 ],
					"style" : "",
					"text" : "decay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.5, 164.5, 82.0, 17.0 ],
					"style" : "",
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.5, 186.0, 116.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.5, 186.0, 116.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 418.0, 393.0, 40.0, 20.0 ],
					"style" : "",
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.0, 393.0, 107.0, 20.0 ],
					"style" : "",
					"text_width" : 60.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 370.5, 83.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 390.0, 418.0, 154.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 413.5, 186.0, 80.0, 80.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 42.0, 474.0, 363.5, 64.0 ],
					"style" : "",
					"text" : "sdt.impact~ inertdoor modaldoor 2 @stiffness 100000000. @dissipation 0.2 @shape 2 @contact0 0 @contact1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 438.0, 245.0, 27.0 ],
					"style" : "",
					"text" : "sdt.inertial inertdoor @mass 0.01"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 644.25, 150.0, 329.75, 150.0, 329.75, 175.0, 172.0, 175.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 644.25, 151.0, 268.75, 151.0, 268.75, 175.0, 50.0, 175.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 172.0, 531.25, 50.0, 531.25 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 283.5, 432.0, 51.5, 432.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 471.5, 366.5, 283.5, 366.5 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 424.0, 365.75, 399.5, 365.75 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 478.5, 412.5, 399.5, 412.5 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 154.0, 434.0, 51.5, 434.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 423.0, 349.5, 73.0, 349.5 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 396.0, 540.5, 562.5, 540.5 ],
					"source" : [ "obj-47", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 396.0, 635.5, 50.0, 635.5 ],
					"source" : [ "obj-47", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 50.0, 712.0, 549.875, 712.0, 549.875, 645.0, 562.5, 645.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 299.0, 532.25, 50.0, 532.25 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 399.5, 469.0, 258.200012, 469.0 ],
					"source" : [ "obj-73", 0 ]
				}
