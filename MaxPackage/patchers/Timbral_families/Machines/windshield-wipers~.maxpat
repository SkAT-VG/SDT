...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 191.5, 82.0, 17.0 ],
					"style" : "",
					"text" : "on / off"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "machines : windshield wipers"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 173.5, 339.0, 41.0, 20.0 ],
									"style" : "",
									"text" : "sig~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 51.0, 393.5, 148.0, 20.0 ],
									"style" : "",
									"text" : "selector~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 295.0, 109.0, 50.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 391.5, 339.0, 41.0, 20.0 ],
									"style" : "",
									"text" : "sig~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 402.5, 148.0, 20.0 ],
									"style" : "",
									"text" : "selector~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 228.0, 100.0, 29.5, 20.0 ],
									"style" : "",
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 198.0, 44.0, 20.0 ],
									"style" : "",
									"text" : "-~ 0.25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 339.0, 28.0, 20.0 ],
									"style" : "",
									"text" : "*~ 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 303.0, 54.0, 20.0 ],
									"style" : "",
									"text" : "clip~ -1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 234.0, 34.0, 20.0 ],
									"style" : "",
									"text" : "cos~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 361.0, 61.0, 20.0 ],
									"style" : "",
									"text" : "onepole~ 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 198.0, 28.0, 20.0 ],
									"style" : "",
									"text" : "*~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 234.0, 61.0, 20.0 ],
									"style" : "",
									"text" : "modulo~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 268.0, 28.0, 20.0 ],
									"style" : "",
									"text" : "*~ 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 268.0, 38.0, 20.0 ],
									"style" : "",
									"text" : "-~ 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 365.0, 72.0, 20.0 ],
									"style" : "",
									"text" : "onepole~ 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 339.0, 43.0, 20.0 ],
									"style" : "",
									"text" : "+~ 600"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 326.0, 303.0, 39.0, 20.0 ],
									"style" : "",
									"text" : "*~ 300"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 162.0, 64.0, 20.0 ],
									"style" : "",
									"text" : "phasor~ 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 51.0, 482.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 326.0, 482.5, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 59.5, 386.75, 189.5, 386.75 ],
									"source" : [ "obj-31", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 335.5, 394.25, 464.5, 394.25 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 63.0, 251.0, 295.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 63.0, 170.0, 77.0, 77.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 364.0, 450.0, 92.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 679.25, 347.5, 28.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 632.25, 347.5, 43.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 632.25, 232.0, 75.0, 75.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 539.0, 251.0, 52.0, 20.0 ],
					"style" : "",
					"text" : "sig~ 0.03"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 364.0, 416.0, 42.0, 20.0 ],
					"style" : "",
					"text" : "*~ 500."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 416.0, 260.0, 28.0 ],
					"style" : "",
					"text" : "sdt.inertial a @mass 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 339.0, 281.0, 223.0, 123.0 ],
					"style" : "",
					"text" : "sdt.dcmotor~ @coils 32 @harshness 0.2 @size 0.05 @reson 0.8 @gearRatio 2.44 @airGain 0. @brushGain 0. @rotorGain 0.05 @gearGain 0.005"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 641.75, 468.5, 734.0, 468.5, 734.0, 224.5, 697.75, 224.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 641.75, 468.5, 736.5, 468.5, 736.5, 223.5, 641.75, 223.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 373.5, 480.0, 611.125, 480.0, 611.125, 336.5, 641.75, 336.5 ],
					"source" : [ "obj-22", 0 ]
				}
