...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "the sdt.scraping~ conttroller is coupled with the sdt.friction~. Velocity and force are shared"
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 67.0, 324.0, 72.0, 23.0 ],
													"text" : "slide 10. 10."
												}
