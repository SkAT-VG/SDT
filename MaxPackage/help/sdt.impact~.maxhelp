...
, 			{
				"box" : 				{
					...
					"text" : "[solids, interactor] Impact between two solid objects."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Simulates the nonlinear impact force generated by two solid objects colliding (e.g. a hammer hitting a resonator).",
