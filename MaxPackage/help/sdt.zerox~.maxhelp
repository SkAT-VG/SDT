...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 279.464601769911269, 150.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 185.0, 422.190265486725821, 104.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 457.190265486725821, 34.0, 23.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 85.5, 411.0, 33.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.5, 440.190265486725821, 39.0, 23.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 383.15486725663709, 150.0, 21.0 ],
					"text" : "transient"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 101.5, 325.464601769911326, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.5, 381.65486725663709, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 5.5, 222.464601769911269, 47.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 325.464601769911326, 104.0, 53.690265486725764 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 85.5, 356.15486725663709, 35.0, 23.0 ],
					"text" : "> 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.5, 279.464601769911269, 52.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 121.0, 117.0, 41.0 ],
					"style" : "SDT-comments",
					"text" : "window overlap"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 293.5, 164.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.5, 197.0, 64.0, 23.0 ],
					"text" : "overlap $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 529.5, 91.0, 67.0, 23.0 ],
					"text" : "loadmess 1"
				}
...
,
					"patching_rect" : [ 466.0, 130.0, 53.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-7", "flonum", "float", 0.200000002980232, 5, "obj-47", "flonum", "float", 0.1240234375, 5, "obj-114", "multislider", "list", 0.1240234375, 5, "obj-115", "live.gain~", "float", -9.803205490112305, 5, "obj-117", "toggle", "int", 0, 5, "obj-119", "flonum", "float", 0.150000005960464, 5, "obj-124", "live.gain~", "float", -70.0 ]
						}
 ]
				}
...
,
					"patching_rect" : [ 564.5, 61.5, 65.5, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 518.0, 10.0, 112.0, 23.0 ],
					"text" : "See also"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 518.0, 32.0, 120.0, 23.0 ],
					"style" : "SDT_package"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 5.5, 376.15486725663709, 34.0, 23.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 551.5, 172.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 384.0, 32.0, 82.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 384.0, 61.0, 68.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 85.5, 245.309734513274179, 186.0, 28.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 95.0, 473.190265486725821, 144.75, 473.190265486725821, 144.75, 411.190265486725821, 194.5, 411.190265486725821 ],
					"source" : [ "obj-122", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 15.0, 214.25, 95.0, 214.25 ],
					"order" : 0,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 303.0, 229.0, 95.0, 229.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 95.0, 312.732300884955635, 194.5, 312.732300884955635 ],
					"order" : 0,
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 585.666666666666629, 165.0, 644.833333333333371, 165.0, 644.833333333333371, 5.0, 527.5, 5.0 ],
					"source" : [ "obj-56", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 562.333333333333371, 164.0, 524.416666666666742, 164.0, 524.416666666666742, 119.0, 475.5, 119.0 ],
					"source" : [ "obj-56", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-55", 0 ],
					"hidden" : 1,
					"midpoints" : [ 509.5, 159.0, 462.0, 159.0, 462.0, 57.0, 393.5, 57.0 ],
					"source" : [ "obj-57", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-124" : [ "live.gain~[1]", "live.gain~", 0 ],
