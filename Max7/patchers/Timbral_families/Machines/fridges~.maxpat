...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.5, 185.0, 82.0, 17.0 ],
					"style" : "",
					"text" : "on / off!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 302.5, 633.0, 37.0, 20.0 ],
					"style" : "",
					"text" : "*~ 0.9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 156.5, 633.0, 43.0, 20.0 ],
					"style" : "",
					"text" : "*~ 0.55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 21.0, 633.0, 37.0, 20.0 ],
					"style" : "",
					"text" : "*~ 0.6"
				}
...
,
					"patching_rect" : [ 558.25, 241.0, 92.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 605.25, 277.0, 28.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 558.25, 277.0, 43.0, 96.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 653.25, 283.0, 75.0, 75.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 302.5, 560.0, 245.0, 66.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.5, 375.0, 87.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 156.5, 345.0, 29.0, 20.0 ],
					"style" : "",
					"text" : "* 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 156.5, 315.0, 78.0, 20.0 ],
					"style" : "",
					"text" : "snapshot~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 102.0, 375.0, 46.0, 20.0 ],
					"style" : "",
					"text" : "sig~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 368.5, 345.0, 43.0, 20.0 ],
					"style" : "",
					"text" : "del 150"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 302.5, 254.0, 58.0, 58.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 302.5, 466.0, 227.0, 85.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.5, 408.0, 209.0, 28.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.5, 170.0, 58.0, 58.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 156.5, 408.0, 143.0, 199.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 21.0, 375.0, 45.0, 20.0 ],
					"style" : "",
					"text" : "*~ 2800"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.5, 254.0, 41.0, 20.0 ],
					"style" : "",
					"text" : "$1 800"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 156.5, 284.0, 32.0, 20.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 567.75, 268.5, 567.75, 268.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 567.75, 383.0, 643.25, 383.0, 643.25, 272.0, 718.75, 272.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 567.75, 383.0, 615.25, 383.0, 615.25, 272.0, 662.75, 272.0 ],
					"source" : [ "obj-37", 0 ]
				}
